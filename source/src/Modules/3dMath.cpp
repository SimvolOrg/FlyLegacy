...
//  2D Subtract
//---------------------------------------------------------------
inline void CVector::Product2D(double p)
{	x *= p;
	y *= p;
}
//---------------------------------------------------------------
...
//  Affect a position
//---------------------------------------------------------------
inline void CVector::Affect(SPosition &p)
{	x = p.lon;
	y = p.lat;
	z = p.alt;
}
//---------------------------------------------------------------
//  Convert in feet and normalize
//---------------------------------------------------------------
void CVector::ArcsToFeetUnit()
{	x = FN_FEET_FROM_ARCS(x);
	y	= FN_FEET_FROM_ARCS(y);
}
//---------------------------------------------------------------
